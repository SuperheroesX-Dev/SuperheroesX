...
import com.sx_dev.sx.objects.potions.CustomPotionEffect;
...
public class PotionInit {
    ...
    public static final Potion INVISIBLE_SPEED = new PotionAdv("inv_speed", false, 8171462, false).registerPotionAttributeModifier(SharedMonsterAttributes.MOVEMENT_SPEED, "91AEAA56-376B-4498-935B-2F7F68070635", 0.20000000298023224D, 2).setBeneficial();

    public static final Potion INVISIBLE_JUMP_BOOST = new PotionAdv("inv_jump_boost", false, 2293580, false).setBeneficial();

    public static final Potion INVISIBLE_HEALTH_BOOST = new HealthBoostAdv(false).registerPotionAttributeModifier(SharedMonsterAttributes.MAX_HEALTH, "5D6F0BA2-1186-46AC-B896-C61C5CEE99CC", 4.0D, 0).setBeneficial();

    public static final Potion INVISIBLE_REGENERATION = new PotionAdv("inv_regeneration", false, 13458603, false).setEffectiveness(0.25D).setBeneficial();
    ...
    public static final Potion INVISIBLE_STRENGTH = new StrengthAdv(false).registerPotionAttributeModifier(SharedMonsterAttributes.ATTACK_DAMAGE, "648D7064-6A60-4F59-8ABE-C2C23A6DD7A9", 0.0D, 0).setBeneficial();
