package com.sx_dev.sx.objects.armor.armorModels;// Date: 4/9/2018 10:59:07 PM
...
public class IronManArmorModel_OLD extends ModelBiped {
    //fields
    //ModelRenderer head;
    ModelRenderer Mask;
//    ModelRenderer body;
...
//    ModelRenderer leftleg;
    ...
    public IronManArmorModel_OLD(float f) {
        super(f, 0, 64, 32);
        textureWidth = 64;
        textureHeight = 32;
