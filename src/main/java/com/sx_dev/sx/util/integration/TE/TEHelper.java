...
public final class TEHelper {
    ...
    public static void addTERecipes() {
        addOredictSmelterRecipe(4000, "ingotTitanium", "ingotGold", RecipeHandler.cloneStack(ItemInit.INGOT_TITANOGOLD, 1));
    }
    ...
    public static void addOredictSmelterRecipe(int energy, String input1, String input2, ItemStack output) {
        for (ItemStack stack1 : OreDictionary.getOres(input1)) {
            for (ItemStack stack2 : OreDictionary.getOres(input2)) {
                addSmelterRecipe(energy, RecipeHandler.cloneStack(stack1, 1), RecipeHandler.cloneStack(stack2, 1), output, ItemStack.EMPTY, 0);
            }
        }
    }
