...
import mini.SuperheroesX.util.handlers.EnumHandler.ParticleType;
...
public class SyncHandler {
    ...
    public static void processIronmanUpdate(int entityId, ParticleType particleType) {
    ...
    public static Map<Integer, ParticleType> getIronmanStates() {
        return jetpackState;
    }
