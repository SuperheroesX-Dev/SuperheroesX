...
import mini.sx.util.network.message.MessageKeyboardSync;
import mini.sx.util.network.message.MessageMouseSync;
...
import static mini.sx.util.helpers.StringHelper.isShiftKeyDown;
