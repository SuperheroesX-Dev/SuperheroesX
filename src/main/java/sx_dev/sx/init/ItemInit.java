...
import sx_dev.sx.objects.armor.*;
import sx_dev.sx.objects.armor.ArmorIronMan.ChestplateIronMan;
import sx_dev.sx.objects.items.ItemBase;
import sx_dev.sx.objects.items.ShieldCaptainAmerica;
import sx_dev.sx.objects.items.TestItem;
import sx_dev.sx.objects.tools.ToolSword;
...
public class ItemInit 
{
    ...
    static {
        ...
        //MARVEL
        if (ModConfig.common.marvelItems) {
            //MCU
